  ...
  data () {
    return {
      ...
      indicatorList: [
        ...
        { isActive: false, id: '#Somedia', title: 'PKL1', linkId: '3' },
        { isActive: false, id: '#ContactManager', title: 'PKL2', linkId: '4'},
        { isActive: false, id: '#MemoryGame', title: 'PKL3', linkId: '5' },
        { isActive: false, id: '#TumblrcClone', title: 'PKL4', linkId: '6' },
        { isActive: false, id: '#Footer', title: 'Contact Us', linkId: '7' }
      ],
      backgrounds: [{ url: 'assets/background-image/background1111.WEBP' }],
      postedBy: [
        {
          artistName: 'user',
          artistAvatar: 'avatar'
